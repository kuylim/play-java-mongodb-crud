...
rem FIRST we load the configuration.config file of extra options.
...
rem FIRST we load a configuration.config file of extra options (if there is one)
...
rem We use the value of the JAVA_OPTS environment variable if defined, rather than the configuration.config.
